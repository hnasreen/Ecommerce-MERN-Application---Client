...
const UploadProduct = ({
    ...
    const handleUploadProduct = async (e) => {
        ...
        console.log("Data state -  Upload Product:", data)
    }
    ...
    return (
        ...
        >
            <div className="bg-white p-4 rounded w-100 h-100 overflow-hidden"
                style={{ maxWidth: '42rem', maxHeight: '80%' }}>

                <div className='d-flex justify-content-between align-items-center pb-3'>
                    <h2 className='fw-bold fs-4'>Upload Product</h2>
                    <div
                        className="ms-auto fs-3 text-dark"
                ...
                <form className='d-grid p-4 g-2 overflow-auto h-100 pb-5' onSubmit={handleSubmit}>
                    ...
                    <select required value={data.category} name='category' onChange={handleOnChange} className='p-2 bg-light border rounded'>
                    ...
                    <div>
                        {
                            data?.productImage[0] ? (
                                        ...
                                        data.productImage.map((el, index) => {
                                            return (
                                                <div className='relative group' key={el}>
                                                    ...
                                                    <div className="ms-auto d-flex align-item-center justify-content-center rounded-pill"
                                                        style={{
                                ...
                                <p
                                    style={{ color: '#dc3545', fontSize: '0.75rem' }} // Equivalent to text-red-600 and text-xs
                                >
                    ...
                    <button className='btn btn-danger text-white mb-4 px-3 py-2' style={{ hover: { backgroundColor: '#c82333' } }}>Upload Product</button>
                </form>
